...
body header {
	background: url(/resources/images/drk.jpg) no-repeat 50% 55%;
...
body header .row #brand {
	background: url(/resources/images/logo4.png) no-repeat 0% 50%;
	height: 90px;
	width: 90px;
	margin: 0px;
	text-indent: -10000px;
...
body footer p {
	padding-top: 40px;
	padding-bottom: 40px;
	background: url(/resources/images/logo4.png) no-repeat 100% 50%;
}
...
<body>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="/resources/images/toscana.jpg" class="d-block w-100"
						alt="...">
				</div>
				<div class="item">
					<img src="resources/images/grape.jpg" class="d-block w-100"
						alt="...">
				</div>
				<div class="item">
					<img src="/resources/images/oak.jpg" class="d-block w-100"
						alt="...">
				</div>
				<div class="item">
					<img src="/resources/images/glass.jpg" class="d-block w-100"
						alt="...">
				</div>
			</div>
			<!-- <a class="left carousel-control"
				style="font-size: 40px; font-weight: bold;"
				href="#carouselExampleIndicators" data-slide="prev"
				onclick="$('#myCarousel').carousel('prev')"><span
				class="slide_arrow">&lt;</span></a> 
				<a class="right carousel-control"
				style="font-size: 40px; font-weight: bold;"
				href="#carouselExampleIndicators" data-slide="next"
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/qwe.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/qwe.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/qwe.jpg" alt=""
				...
				<li class="col-6 last"><img src="/resources/images/qwe.jpg"
